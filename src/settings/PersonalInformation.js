...
const PersonalInformation = ({
    ...
    const [updatePersonalInformation, { loading: loadingProfileFields }] = useMutation(
        UPDATE_PROFILE_FIELDS,
        {
    ...
    const [updateCommunicationPreference, { loading: loadingCommPref }] = useMutation(
        UPDATE_COMMUNCATION_PREFERENCE,
        {
    ...
    return <PaddedView>
        ...
        <View>
            {loading && <Overlay><ActivityIndicator /></Overlay>}
            <Container>
                <TextInput
                    label={'Email'}
                    type={'email'}
                    ...
                    onSubmitEditing={() => updatePersonalInformation({
                        variables: { profileFields: [{ field: 'Email', value: values.email }] }
                    })}
                />
                <Switch
            ...
            <Container>
                <TextInput
                    ...
                    onSubmitEditing={() => updatePersonalInformation({
                        variables: { profileFields: [{ field: 'PhoneNumber', value: values.phoneNumber }] }
                    })}
                />
                <Switch
                    icon='comment-lines'

...
import { H6, Button } from '@apollosproject/ui-kit';
import { useForm } from '../../hooks';

import { UPDATE_PROFILE, HANDLE_LOGIN } from '../mutations';

import { TextInput, Radio, RadioButton, DateInput } from '../../ui/inputs';
import { Container } from '../containers';

const validation = {
    firstName: (value) =>
        value && value !== '' ? false : 'Please enter your first name',
    lastName: (value) =>
        value && value !== '' ? false : 'Please enter your last name',
    birthDate: (value) =>
    ...
    return (
        <Container title={titleText} description={propmtText}>
            {get(errors, 'general', null) ? (
                <H6 padded>{get(errors, 'general')}</H6>
            ) : null}
...
ProfileInformationForm.defaultProps = {
    ...
    propmtText:
        'By getting to know you better we can make your app experience unique to you. Please take a moment to complete your profile information.',

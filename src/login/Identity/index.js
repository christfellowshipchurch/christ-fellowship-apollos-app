        ...
        if (email) {
            validateIdentity({
                ...
                update: (
                    ...
                    {
                        data: {
                            isValidIdentity: { success, isExistingIdentity },
                        },
                    }
                ) => {
                    if (success) {
            ...
            requestPin({
                ...
                update: (
                    ...
                    {
                        data: {
                            requestSmsLoginPin: { success, isExistingIdentity },
                        },
                    }
                ) => {
                    if (success) {
    ...
    return (
        <Container title={title} description={description}>
            ...
            <StyledFlexedView>
                ...
                />
                <StyledH6>{disclaimerText}</StyledH6>
            </StyledFlexedView>
...
IdentityForm.defaultProps = {
    ...
    disclaimerText:
        'I understand and agree to the following policies as laid out by Christ Fellowship Church',
    buttonText: 'Continue',
};
